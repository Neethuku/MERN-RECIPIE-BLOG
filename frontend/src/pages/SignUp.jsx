 ...
 const handleSubmit = async (e) =>{
  ...
  try {
    ...
    if(data.success === false){
      ...
      return setErrorMessage('already registered, please sign-in')
    }
    setLoading(false);
    if(res.ok){
      navigate('/sign-in');
  ...
  return (
    <div className="min-h-screen mt-20 ">
      <div className="flex p-3 max-w-sm mx-auto flex-col md:flex-row md:items-center gap-5 ">
        ...
        <p className="text-sm mt-5">This is a demo project you ca signup with your email and password or with google</p>
        </div> */}
        {/* right */}
        <div className="flex-1">
